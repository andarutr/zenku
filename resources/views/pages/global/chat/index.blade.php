...
<div class="row">
    ...
    <div class="col-lg-8 mx-auto">
        <div class="card shadow mt-3">
            <div class="card-body">
              <img src="/img/profile/{{ $chat->picture }}" class="img-fluid rounded-circle" width="80">&nbsp; To : {{ $chat->name }} <span class="badge bg-success text-white"><i class="fas fa-comment"></i> {{ $count_chat }}</span>
    ...
    <div class="col-lg-8 mx-auto">
        <div class="card shadow mt-3">
            <div class="card-body">
              <img src="/img/profile/{{ $chat->picture }}" class="img-fluid rounded-circle" width="80">&nbsp; From : {{ $chat->name }} <span class="badge bg-success text-white"><i class="fas fa-comment"></i> {{ $count_chat }}</span> 
